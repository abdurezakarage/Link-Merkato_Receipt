...
interface FetchedClearanceDocument {
...
interface ClearanceViewerProps {
  transportDocument?: ClearanceDocument;
  declarationNumber?: string;
  fetchedDocuments?: FetchedClearanceDocument[];
}

export default function ClearanceViewer({ 
  transportDocument, 
  declarationNumber,
  ...
  const [fetchedDocuments, setFetchedDocuments] = useState<FetchedClearanceDocument[]>([]);
  ...
  console.log("ClearanceViewer render:", {
    declarationNumber,
  ...
  const fetchClearanceDocuments = useCallback(async () => {
    ...
    try {
      ...
      console.log("Fetching clearance documents from URL:", url);
  ...
  }, [declarationNumber, passedFetchedDocuments, fetchClearanceDocuments]);
    ...
    <div className="p-4 bg-gray-50 min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-lg text-center text-gray-600">
          View and download transitor documents
        </p>
      </div>
      ...
      {!declarationNumber ? (
        ...
        <div className="flex items-center justify-center h-full text-gray-500">
          <div className="text-center">
            <File size={48} className="mx-auto mb-4 text-gray-300" />
            <p className="text-lg">No transitor documents found for declaration number: {declarationNumber}</p>
          </div>
        </div>
      ) : (
